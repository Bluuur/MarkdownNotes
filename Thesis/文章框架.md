...
利用高通量基因组测序数据，我们对选定的枯草芽孢杆菌群进行了基因组组装、注释和比较分析。通过基因簇分析，我们鉴定了表面素合成相关的 *srfA* 操纵子基因以及 *abrB codY comA degU sinR* 这几个功能基因，并与参考序列进行了比对。
...
| Gene symbol | Specie                       |
| :---------- | :--------------------------- |
| $srfA-A$    | *Bacillus subtilis*          |
| $srfA-B$    | *Bacillus subtilis*          |
| $srfA-C$    | *Bacillus amyloliquefaciens* |
| $srfA-D$    | *Bacillus subtilis*          |
| $abrB$      | *Bacillus subtilis*          |
| $codY$      | *Bacillus subtilis*          |
| $comA$      | *Bacillus subtilis*          |
| $degU$      | *Bacillus subtilis*          |
| $sinR$      | *Bacillus subtilis*          |
