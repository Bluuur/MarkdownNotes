...
58. 查询满足条件的(sno,cno)对, 其中该学号的学生没有选修该课程号 cno 的课程
    ...
    <img src="数据库实验报告.assets/image-20220522153859294.png" alt="image-20220522153859294" style="zoom:80%;" />
...
59. 查询每个学生的课程成绩最高的成绩信息(sno,cno,grade)
    ...
    <img src="数据库实验报告.assets/image-20220522154116602.png" alt="image-20220522154116602" style="zoom:80%;" />
...
60. 查询学生总人数
    ...
    <img src="数据库实验报告.assets/image-20220522154156577.png" alt="image-20220522154156577" style="zoom:80%;" />
...
61. 查询年龄在20-30岁直接的学生的姓名, 姓名, 所在系
    ...
    <img src="数据库实验报告.assets/image-20220522154241175.png" alt="image-20220522154241175" style="zoom:80%;" />
...
62. 查询所有课程的总学分数和平均学分数,以及最高学分和最低学分
    ...
    <img src="数据库实验报告.assets/image-20220522154325911.png" alt="image-20220522154325911" style="zoom:80%;" />
...
63. 求成绩低于该门课程平均成绩的学生的成绩信息(sno,cno,grade)
    ...
    <img src="数据库实验报告.assets/image-20220522154412450.png" alt="image-20220522154412450" style="zoom:80%;" />
...
64. 查询各系的学生的人数并按人数从多到少排序 
    ...
    <img src="数据库实验报告.assets/image-20220522154448503.png" alt="image-20220522154448503" style="zoom:80%;" />
...
65. 创建年龄大于23岁的学生的视图
    ...
    <img src="数据库实验报告.assets/image-20220522154610014.png" alt="image-20220522154610014" style="zoom:80%;" />
...
66. 查询选修了课程的学生总数
    ...
    <img src="数据库实验报告.assets/image-20220522154654099.png" alt="image-20220522154654099" style="zoom:80%;" />
...
67. 查询选修了3门课程以上的学生的学号和姓名
    ...
    <img src="数据库实验报告.assets/image-20220522154907177.png" alt="image-20220522154907177" style="zoom:80%;" />
...
68. 查询平均分超过80分的学生的学号和平均分
    ...
    <img src="数据库实验报告.assets/image-20220522154945733.png" alt="image-20220522154945733" style="zoom:80%;" />
...
69. 比较: 求各学生的60分以上课程的平均分
    ...
    <img src="数据库实验报告.assets/image-20220522155025710.png" alt="image-20220522155025710" style="zoom:80%;" />
...
70. 查询”信息系”(IS)中选修了2门课程以上的学生的学号
    ...
    <img src="数据库实验报告.assets/image-20220522155206098.png" alt="image-20220522155206098" style="zoom:80%;" />
...
71. 查询选修了1号课程或2号课程的学生的学号
    ...
    <img src="数据库实验报告.assets/image-20220522155250685.png" alt="image-20220522155250685" style="zoom:80%;" />
...
72. 查询平均成绩少于70分的学生的学号
    ...
    <img src="数据库实验报告.assets/image-20220522155400108.png" alt="image-20220522155400108" style="zoom:80%;" />
