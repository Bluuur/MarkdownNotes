...
$$
\mathrm{d} A=F \mathrm{d} I=p S \mathrm{d} l=p \mathrm{d} V
$$
系统体积由 $V_{1}$ 变为 $V_{2}$, 系统对 外界作总功为：
$$
\boldsymbol{A}=\int \mathrm{d} \boldsymbol{A}=\int_{V_{1}}^{V_{2}} p \mathrm{d} V
$$
功的大小等于在$P-V$图 中曲线下的面积
...
$1 k=4.18 \mathrm{~J}, \quad 1 \mathrm{~J}=0.24 k$
...
C=\frac{d Q}{d T}
$$
系统由温度 $T_{1}$ 变到温度 $T_{2}$ 的 过程中所吸收的热量:
$$
...
![image-20210623235941656](image/image-20210623235941656.png)

+   效率$\eta=\frac{W(做功)}{Q(吸热)}$
+   分析哪些过程**做功**,哪些过程**吸热**
+   求出每个过程的Q或W
...
+  <font color="red">有且仅有准静态,无能量耗散的过程是可逆过程</font>
...
>  答案:B
>
>  第一句对,第二句错,因为不可逆过程可以是非自发的,如自发过程的逆过程
...
![image-20210331232227125](image\image-20210331232227125.png)
...
![image-20210410215715028](image\image-20210410215715028.png)
...
![image-20210410221652972](image\image-20210410221652972.png)
...
![image-20210410231116808](image\image-20210410231116808.png)
